...
<section>
  ...
  <?php
        ...
        $reqManga = mysqli_query($con, "SELECT * FROM manga where prom>0  order by date desc");
          ...
          <div class="<?php echo ($row['prom'] != 0) ? 'boxprom' : 'box'; ?>">
            <a href="more_info.php?id=<?=$row['id']?>">
              ...
              <div><h4 style="margin-left: 20px ">prix :  
                  ...
                  <a class="delete_btn" href="add_panier.php?id=<?=$row['id']?>&loca=listprom.php">
