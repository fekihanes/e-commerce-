...
<?php include "navbar.php"?>
    ...
    <section>
        ...
        $Data = array();
        $reqManga = mysqli_query($con, "SELECT * FROM manga WHERE prix between $min and $max ");
        ...
        ?>         
            ...
            <a class="delete_btn" href="add_panier.php?id=<?=$row['id']?>&loca=pricerange.php?min=<?=$min?>&max=<?=$max?>">
