...
<?php include "navbar.php"?>
    ...
    <section>
        ...
        $Data = array();
        $reqManga = mysqli_query($con, "SELECT * FROM manga WHERE nom LIKE '%".$_GET["name"]."%' or auteur LIKE '%".$_GET["name"]."%'  order by date desc");
        ...
        ?>         
            ...
            <a href="more_info.php?id=<?=$row['id']?>">
              ...
              <div><h4 style="margin-left: 20px ">prix :  
                  ...
                  <a class="delete_btn" href="add_panier.php?id=<?=$row['id']?>&loca=find.php?name=<?=$_GET['name']?>">
